...
class QuoteService < ApplicationService
  ...
  HAPPINESS_QUOTES = [
    ...
    'Happiness is a butterfly, which when pursued, is always beyond your grasp. - Nathaniel Hawthorne',
    ...
    'Happiness is not in the mere possession of money; it lies in the joy of achievement. - FDR',
    'Very little is needed to make a happy life. - Marcus Aurelius',
    'Happiness is letting go of what you think your life is supposed to look like. - Unknown',
    'The only joy in the world is to begin. - Cesare Pavese',
    'Be happy for this moment. This moment is your life. - Omar Khayyam',
    'Happiness is not something you postpone; it is something you design for the present. - Jim Rohn',
    'Think of all the beauty still left around you and be happy. - Anne Frank',
    'Happiness often sneaks in through a door you didn\'t know you left open. - John Barrymore',
    'The key to being happy is knowing you have the power to choose what to let go. - Dodinsky',
