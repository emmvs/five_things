...
class HappyThingsTest < ApplicationSystemTestCase
  ...
  test "Creating a new happy thing" do
    ...
    assert_selector "h1", text: "HappyThings"
    ...
    fill_in "Name", with: "Capybara happy thing"
    click_on "Create happy thing"

    # We expect to be back on the page with the title "HappyThings"
    # and to see our "Capybara happy thing" added to the list
    assert_selector "h1", text: "HappyThings"
    assert_text "Capybara happy thing"
  end
